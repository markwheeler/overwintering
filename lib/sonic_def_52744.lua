...
SonicDef = {
    ...
    dynamic_params = {
      ...
      chord_noise_level_low = 0.012,
      chord_noise_level_high = 0.006,
      ...
      perc_sub_osc_level_low = 0.2,
      perc_sub_osc_level_high = 0,
      perc_crackle_level_low = 0,
      perc_crackle_level_high = 0.02,
      perc_env_release_low = 0.8,
      perc_env_release_high = 0.02,
      perc_panning_low = -0.85,
      perc_panning_high = 0.85,
      perc_lp_filter_cutoff_low = 600,
      perc_lp_filter_cutoff_high = 2000,
    ...
    params = {
      ...
      perc_noise_level = 0.005,
  
      perc_lp_filter_cutoff_mod_env = 0.1,
